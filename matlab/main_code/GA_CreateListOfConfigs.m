function [configs,gridSize] = GA_CreateListOfConfigs(bounds,steps,samples,onlyGridSize)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
assert(ntx_steps>=256);
assert(nty_steps>=256);
assert(ns_steps>=256);
assert(nr_steps>=256);
...
configs(:,3) = r2_steps(int16(samples(:,3)+1)); 
